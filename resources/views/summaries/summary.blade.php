...
<div class="card">
	...
	<div class="card-body">
		<h3 class="text-center lead"><a href="" style="text-decoration: none;">Position Applied for: {{$userdetails->position}}</a></h3>
		<hr>
		<h5 class="text-center">Personal Details</h5>
		<hr>
        <form action="{{route('summaries.update')}}" method="post">
                {{csrf_field()}}
